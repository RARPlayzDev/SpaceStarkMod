package net.rarpalyz.spacestark.sound;
...
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, Spacestark.MOD_ID);
    ...
    public static RegistryObject<SoundEvent> TERA = registerSoundEvent("tera");

    private static RegistryObject<SoundEvent> registerSoundEvent(String name) {
        return SOUND_EVENTS.register(name, () -> new SoundEvent(new ResourceLocation(Spacestark.MOD_ID, name)));
    }
